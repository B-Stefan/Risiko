package main.java.ui.GUI.TableModels;
...
public class PlayerInfoTableModel extends DefaultTableModel{
	...
	public PlayerInfoTableModel(final Game game, final Vector<String> columnNames) throws GameNotStartedException{
		super();
		this.game = game;
	...
	public void setDataVector(final List<Player> players) throws GameNotStartedException{
        ...
        for (final Player player : players) {
            ...
            String n = (player.getName() + " (" + player.getColor().toString() +")");
            playerInVector.add(n);
