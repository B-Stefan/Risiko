...
public class Fight {
	 ...
	 * @throws InvalidFightException 
	 */
	public void defending(int defendersArmies) throws NotEnoughArmiesToDefendException, InvalidAmountOfArmiesException, CountriesNotConnectedException, AlreadyDicedException, TurnNotAllowedStepException, TurnNotInCorrectStepException, ArmyAlreadyMovedException, InvalidFightException{
	 ...
	 * @throws InvalidFightException 
	 */
	public void defending(Stack<Army> defendersArmies)throws InvalidAmountOfArmiesException, CountriesNotConnectedException, AlreadyDicedException, TurnNotAllowedStepException, TurnNotInCorrectStepException, ArmyAlreadyMovedException, InvalidFightException{
		if (this.from.getOwner() == this.to.getOwner()){
			throw new InvalidFightException();
		}
	 ...
	 * @throws TurnNotAllowedStepException 
	 */
	private int[] result() throws CountriesNotConnectedException, TurnNotAllowedStepException, TurnNotInCorrectStepException, ArmyAlreadyMovedException{
		int[] res = new int[3];
	...
	public void setResult() throws CountriesNotConnectedException, TurnNotAllowedStepException, TurnNotInCorrectStepException, ArmyAlreadyMovedException{
		this.result = result();
	}
