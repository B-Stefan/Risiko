...
public interface IFight extends Remote, Serializable,IToStringRemote {
     ...
     * @throws commons.exceptions.NotEnoughArmiesToAttackException
     * @throws commons.exceptions.InvalidAmountOfArmiesException
     * @throws commons.exceptions.AlreadyDicedException
     * @throws commons.exceptions.InvalidFightException
     */
     ...
     * @throws commons.exceptions.ArmyAlreadyMovedException
     * @throws commons.exceptions.TurnNotInCorrectStepException
     * @throws commons.exceptions.TurnNotAllowedStepException
     * @throws InvalidFightException
     * @throws commons.exceptions.AggessorNotThrowDiceException
